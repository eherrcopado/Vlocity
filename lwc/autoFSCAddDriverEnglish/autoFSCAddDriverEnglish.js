...
import { OMNIDEF } from './autoFSCAddDriverEnglish_def.js';
import tmpl from './autoFSCAddDriverEnglish.html';
import tmpl_nds from './autoFSCAddDriverEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoFSCAddDriverEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
