...
import { OMNIDEF } from './watercraftFSCModifyCoveragesEnglish_def.js';
import tmpl from './watercraftFSCModifyCoveragesEnglish.html';
import tmpl_nds from './watercraftFSCModifyCoveragesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class watercraftFSCModifyCoveragesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
