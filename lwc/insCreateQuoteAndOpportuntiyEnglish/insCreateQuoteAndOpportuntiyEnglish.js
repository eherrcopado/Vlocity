...
import { OMNIDEF } from './insCreateQuoteAndOpportuntiyEnglish_def.js';
import tmpl from './insCreateQuoteAndOpportuntiyEnglish.html';
import tmpl_nds from './insCreateQuoteAndOpportuntiyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insCreateQuoteAndOpportuntiyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
