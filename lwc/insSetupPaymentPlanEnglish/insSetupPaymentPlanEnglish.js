...
import { OMNIDEF } from './insSetupPaymentPlanEnglish_def.js';
import tmpl from './insSetupPaymentPlanEnglish.html';
import tmpl_nds from './insSetupPaymentPlanEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insSetupPaymentPlanEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
