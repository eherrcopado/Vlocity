...
import { OMNIDEF } from './lwcAccountUpdateBillingAddressEnglish_def.js';
import tmpl from './lwcAccountUpdateBillingAddressEnglish.html';
import tmpl_nds from './lwcAccountUpdateBillingAddressEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcAccountUpdateBillingAddressEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
