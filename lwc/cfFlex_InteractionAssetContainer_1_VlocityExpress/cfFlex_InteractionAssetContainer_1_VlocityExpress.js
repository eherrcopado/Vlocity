import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_ins/utility";
          ...
          export default class cfFlex_InteractionAssetContainer_1_VlocityExpress extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              registerPubSub() {
                pubsub.register('Flex_InteractionAssetContainer', {
