...
import { OMNIDEF } from './autoFSCModifyCoveragesEnglish_def.js';
import tmpl from './autoFSCModifyCoveragesEnglish.html';
import tmpl_nds from './autoFSCModifyCoveragesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoFSCModifyCoveragesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
