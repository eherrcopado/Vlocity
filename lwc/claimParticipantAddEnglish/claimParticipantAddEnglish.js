...
import { OMNIDEF } from './claimParticipantAddEnglish_def.js';
import tmpl from './claimParticipantAddEnglish.html';
import tmpl_nds from './claimParticipantAddEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class claimParticipantAddEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
