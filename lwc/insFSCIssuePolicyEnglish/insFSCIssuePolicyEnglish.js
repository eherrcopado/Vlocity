...
import { OMNIDEF } from './insFSCIssuePolicyEnglish_def.js';
import tmpl from './insFSCIssuePolicyEnglish.html';
import tmpl_nds from './insFSCIssuePolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insFSCIssuePolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
