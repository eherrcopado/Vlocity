...
import { OMNIDEF } from './lwcpropertyFNOLEnglish_def.js';
import tmpl from './lwcpropertyFNOLEnglish.html';
import tmpl_nds from './lwcpropertyFNOLEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcpropertyFNOLEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
