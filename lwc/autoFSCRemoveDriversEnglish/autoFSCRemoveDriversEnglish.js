...
import { OMNIDEF } from './autoFSCRemoveDriversEnglish_def.js';
import tmpl from './autoFSCRemoveDriversEnglish.html';
import tmpl_nds from './autoFSCRemoveDriversEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoFSCRemoveDriversEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
