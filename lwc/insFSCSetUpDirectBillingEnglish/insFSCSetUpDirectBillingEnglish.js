...
import { OMNIDEF } from './insFSCSetUpDirectBillingEnglish_def.js';
import tmpl from './insFSCSetUpDirectBillingEnglish.html';
import tmpl_nds from './insFSCSetUpDirectBillingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insFSCSetUpDirectBillingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
