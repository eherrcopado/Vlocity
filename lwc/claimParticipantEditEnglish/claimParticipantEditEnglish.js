...
import { OMNIDEF } from './claimParticipantEditEnglish_def.js';
import tmpl from './claimParticipantEditEnglish.html';
import tmpl_nds from './claimParticipantEditEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class claimParticipantEditEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
