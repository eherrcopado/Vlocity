...
import { OMNIDEF } from './insFSCPolicyOneTimePaymentEnglish_def.js';
import tmpl from './insFSCPolicyOneTimePaymentEnglish.html';
import tmpl_nds from './insFSCPolicyOneTimePaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insFSCPolicyOneTimePaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
