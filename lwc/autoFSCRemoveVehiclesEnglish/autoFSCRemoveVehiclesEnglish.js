...
import { OMNIDEF } from './autoFSCRemoveVehiclesEnglish_def.js';
import tmpl from './autoFSCRemoveVehiclesEnglish.html';
import tmpl_nds from './autoFSCRemoveVehiclesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoFSCRemoveVehiclesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
