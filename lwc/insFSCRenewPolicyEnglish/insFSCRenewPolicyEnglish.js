...
import { OMNIDEF } from './insFSCRenewPolicyEnglish_def.js';
import tmpl from './insFSCRenewPolicyEnglish.html';
import tmpl_nds from './insFSCRenewPolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insFSCRenewPolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
