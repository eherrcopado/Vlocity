...
import { OMNIDEF } from './billingPaperlessEnglish_def.js';
import tmpl from './billingPaperlessEnglish.html';
import tmpl_nds from './billingPaperlessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class billingPaperlessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
