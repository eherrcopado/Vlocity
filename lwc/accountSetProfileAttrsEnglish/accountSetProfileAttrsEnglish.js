...
import { OMNIDEF } from './accountSetProfileAttrsEnglish_def.js';
import tmpl from './accountSetProfileAttrsEnglish.html';
import tmpl_nds from './accountSetProfileAttrsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountSetProfileAttrsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
