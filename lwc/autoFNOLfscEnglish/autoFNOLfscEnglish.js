...
import { OMNIDEF } from './autoFNOLfscEnglish_def.js';
import tmpl from './autoFNOLfscEnglish.html';
import tmpl_nds from './autoFNOLfscEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoFNOLfscEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
