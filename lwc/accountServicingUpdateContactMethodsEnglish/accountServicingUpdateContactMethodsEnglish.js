...
import { OMNIDEF } from './accountServicingUpdateContactMethodsEnglish_def.js';
import tmpl from './accountServicingUpdateContactMethodsEnglish.html';
import tmpl_nds from './accountServicingUpdateContactMethodsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountServicingUpdateContactMethodsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
