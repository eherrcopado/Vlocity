import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_ins/utility";
          ...
          export default class cfInsClaimParticipantsCardExpress extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              registerPubSub() {
                this.template.addEventListener('addparticipant', this.handleEventAction.bind(this, data.events[0],0));
this.template.addEventListener('editparticipant', this.handleEventAction.bind(this, data.events[1],1));
              }
