...
import { OMNIDEF } from './insFSCPolicyPaymentEnglish_def.js';
import tmpl from './insFSCPolicyPaymentEnglish.html';
import tmpl_nds from './insFSCPolicyPaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insFSCPolicyPaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
