import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfFlex_InteractionStoryContainer_1_Vlocity extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              registerPubSub() {
                this.template.addEventListener('triggerstate', this.handleEventAction.bind(this, data.events[0],0));
              }
