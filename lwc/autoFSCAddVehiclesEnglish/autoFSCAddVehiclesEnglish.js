...
import { OMNIDEF } from './autoFSCAddVehiclesEnglish_def.js';
import tmpl from './autoFSCAddVehiclesEnglish.html';
import tmpl_nds from './autoFSCAddVehiclesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoFSCAddVehiclesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
