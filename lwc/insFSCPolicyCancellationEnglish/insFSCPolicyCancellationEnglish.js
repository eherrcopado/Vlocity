...
import { OMNIDEF } from './insFSCPolicyCancellationEnglish_def.js';
import tmpl from './insFSCPolicyCancellationEnglish.html';
import tmpl_nds from './insFSCPolicyCancellationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insFSCPolicyCancellationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
